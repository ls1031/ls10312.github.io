...
class _MyHomePageState extends State<MyHomePage> {
 ...
 var CitedNum;
 var date;
  var currState = PageState.reading;

  String _value = "Citations";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      getSearchBar(searchValue, (value) => setState(() => searchValue = value), (value) async {
       searchRes = await fetchSuggestions(value, 1);
      return searchRes;
      }, (value) {

        currState = PageState.reading;}, _value),
       ...
       child: Column( 
        ...
        children: [
            ...
            Container(
              ...
              margin:  EdgeInsets.fromLTRB(MediaQuery.of(context).size.width * 0.1,20,MediaQuery.of(context).size.width * 0.1,0),
